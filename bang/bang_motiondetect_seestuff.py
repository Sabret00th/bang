...
fresh_eyes_counter = 0
fresh_eyes_pathname = "C:\Users\pgilmore\Desktop\\bang\\bang_vsketchpad\\fresh_eyes.jpg"
...
(quick_grab, quick_frame) = camera.read()
cv2.imwrite(fresh_eyes_pathname,quick_frame)
print(fresh_eyes_pathname)
